...
kontratazioaSchema = folder.ATFolderSchema.copy() + atapi.Schema((
    ...
    atapi.DateTimeField(
        ...
        #schemata ='default',
        widget=atapi.CalendarWidget(
            label=_(u"published_date_doue"),
            description=_(u"Description of published_date_doue"),
            show_hm=False,
        ),
    ),
    atapi.FileField('doue_file',
                  searchable=1,
		  languageIndependent=1,
                  storage = atapi.AnnotationStorage(migrate=True),
                  widget=atapi.FileWidget(
     ...
     atapi.TextField('doue_information',
                        required=False,
                        searchable=True,
			storage=atapi.AnnotationStorage(),
                        validators=('isTidyHtmlWithCleanup',),
                        default_output_type='text/x-html-safe',
                        widget=atapi.RichWidget(label=_(u'doue_information'),
                                                description=_(u'Description of doue_information'),
                                                rows=3,
                                                allow_file_upload=False),
                   ),
    ...
    atapi.FileField('desistimiento_file',
                  searchable=1,
                  storage = atapi.AnnotationStorage(migrate=True),
		  languageIndependent=1,
                  widget=atapi.FileWidget(
                     label=_(u'desistimiento_file'),
                     ),
                  ),
     atapi.DateTimeField(
        name='desistimiento_adjudikazio_date',
        storage = atapi.AnnotationStorage(),
        required=False,
        languageIndependent=1,
        #searchable=1,
        ...
        #schemata ='default',
        widget=atapi.CalendarWidget(
            label=_(u"desistimiento_adjudikazio_date"),
            description=_(u"Description of desistimiento_adjudikazio_date"),
            show_hm=False,
        ),
    ),

    atapi.DateTimeField(
        name='desistimiento_profile_date',
        storage = atapi.AnnotationStorage(),
        required=False,
        languageIndependent=1,
        #searchable=1,
        ...
        #schemata ='default',
        widget=atapi.CalendarWidget(
            label=_(u"desistimiento_profile_date"),
            description=_(u"Description of desistimiento_profile_date"),
        ),
    ),
